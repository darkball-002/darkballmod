package net.darkball.darkballmod.MainClass.block;

import net.darkball.darkballmod.darkballmod;
import net.darkball.darkballmod.MainClass.block.custom.*;
...
public class ModBlocks {
    ...
    DeferredRegister.create(ForgeRegistries.BLOCKS, darkballmod.MOD_ID);
    ...
    public static final RegistryObject<Block> BEDROCK_SAPPHIRE_ORE = registerBlock("bedrock_sapphire_ore",
